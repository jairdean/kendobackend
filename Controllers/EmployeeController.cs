...
namespace WebAppMVC.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ViewResult LoadEmployees()
        {
            ...
            new EmployeeViewModel{ FullName = "Miguel Saritama", EmployeeID = "id1", SIN = 11, PhoneNumber = "5612005637", City = "Boynton Beach", Salary = 1111.666m, Country = "USA"},
            new EmployeeViewModel{ FullName = "Jonathan Valles", EmployeeID = "id2", SIN = 22, PhoneNumber = "2222005637", City = "Delray Beach", Salary = 222.644m, Country = "UNITED STATES"},
            new EmployeeViewModel{ FullName = "Robert Moran", EmployeeID = "id3", SIN = 33, PhoneNumber = "3332005637", City = "Pompano Beach", Salary = 333.59m, Country = "UNITED STATES OF AMERICA"},
            new EmployeeViewModel{ FullName = "Jairo Flores", EmployeeID = "id4", SIN = 44, PhoneNumber = "4442005637", City = "Mississauga", Salary = 111, Country = "POLAND"},
            ...
            new EmployeeViewModel{ FullName = "NameM", EmployeeID = "id12", SIN = 112, PhoneNumber = "5612001212", City = "Mississauga", Salary = 111, Country = "COSTA RICA"},
